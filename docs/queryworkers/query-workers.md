...
4. Write a [SQL](sql/index) [C8QL](c8ql/index) query.
5. Click **Save Query**.
...
Click the chat bubbles to display the [Execution Plan](running-queries#execution-plan) of the query worker without running the query.
