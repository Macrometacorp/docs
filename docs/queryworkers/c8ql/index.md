...
:::note
If this is your first time with C8QL then be sure to check out the [C8QL GoT Tutorial](got-tutorial/index) before you head off to the in-depth documentation!
:::
...
For some example queries, please refer to [Queries and Query Workers](../index), [Examples](examples/index), and [C8QL GoT Tutorial](got-tutorial/index).
