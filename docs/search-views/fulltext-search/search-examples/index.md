...
- A fabric named `Hotels` with a document collection named `hotel_reviews`. Refer to [Create a Fabric](../../../geofabrics/create-geofabric.md) and [Create a Collection](../../../collections/documents/create-document-store.md).
