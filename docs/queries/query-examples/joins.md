...
In order to get all books with their authors you can use a [graph traversal](../../database/graphs/graph-queries/traversal-queries/#working-with-collection-sets)
