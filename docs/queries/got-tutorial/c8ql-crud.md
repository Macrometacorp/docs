...
For this tutorial, [Create a Document collection](../../collections/types-collections/documents/create-document-store.md) in the console. For more information about collections, refer to [Collections](../../collections/index.md).
...
For more information about this task, refer to [Add Documents to a Collection](../../collections/types-collections/documents/add-document.md).
