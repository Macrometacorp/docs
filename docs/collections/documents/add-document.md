...
1. Enter a `_key` if you want to and then click **Create**.
...
Follow these instructions to add documents to an existing document collection from a JSON or CV file.
