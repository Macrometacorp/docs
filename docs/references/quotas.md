...
This page describes the rate limits for all PaaS GDN customers. Each quota applies on a per-Region basis unless otherwise specified. Contact justin@macrometa.com if you would like to request higher metered tier limits or learn about [dedicated fabrics](https://www.macrometa.com/enterprise).
