...
For information on performing scatter and gather using [map:tokenize()](tokenize), and [map:collect()](collect), refer to the examples in [Data Pipeline Examples](../../../examples/data-pipelines).
