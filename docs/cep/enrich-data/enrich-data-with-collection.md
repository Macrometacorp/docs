...
For more information about stream workers and how they work, refer to [Stream Workers](index).
...
Run the following query using one of the methods described in [Running Queries](../../queryworkers/running-queries) to add the records to the collection. Each line is a separate record.
...
There are several ways to [publish messages to streams](../../streams/stream-tasks/publish-messages), this page shows you how to do it in the Macrometa console API reference.
