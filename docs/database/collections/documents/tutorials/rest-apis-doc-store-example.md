---
sidebar_position: 70
title: REST APIs Document Collection Example
---
...
This page demonstrates how you can work with Macrometa GDN document collections using the REST API. For more information about using Macrometa APIs, refer to [APIs](../../../../developer-hub/api-docs/index.md).
