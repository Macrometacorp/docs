...
:::note
Please see [C8QL GoT Tutorial](../../../../compute/queryworkers/queries/got-tutorial/) and [C8QL Examples](../../../../compute/queryworkers/queries/query-examples/) for more examples on how you can use C8QL.
:::
