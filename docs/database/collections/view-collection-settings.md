...
Use [gdnsl collection describe](../../developer-hub/cli/collections-cli#gdnsl-collection-describe) to view information about a collection.
...
Use [gdnsl collection update](../../developer-hub/cli/collections-cli#gdnsl-collection-update) to change collection settings.
