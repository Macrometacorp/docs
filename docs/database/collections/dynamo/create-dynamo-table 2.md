...
Use [createTable](../../../compute/queryworkers/queries/dynamo-support/reference/createTable) to create a new Dynamo table in the collection.

Refer to the other topics in [Dynamo Support](../../../compute/queryworkers/queries/dynamo-support/using-aws-cli.md) for various examples using this function with the SDK, CLI, and Boto3.
