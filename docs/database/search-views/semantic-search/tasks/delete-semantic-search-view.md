---
sidebar_position: 50
title: Delete Semantic Search Views
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

This page explains how to delete a semantic search view.

<Tabs groupId="operating-systems">
<TabItem value="console" label="Web Console">

Follow these instructions to delete a semantic search view using the GDN console web UI.
...
Use our interactive API Reference with code generation in 18 programming languages to [Remove (Delete) a Search View](https://www.macrometa.com/docs/api#/operations/deleteView).

</TabItem>
<TabItem value="cli" label="CLI">

Use our command line interface to [Delete a Search View](../../../../developer-hub/CLI/search-views-cli#gdnsl-view-delete).
...
const searchViewName = "example_search_view"; // Replace with the name of the search view you want to delete.
