...
You can also use the CLI command [gdnsl fabric describe](../cli/fabrics-cli.md#gdnsl-fabric-describe) or the API command to get [Information about a GeoFabric](https://macrometa.com/docs/api#/operations/InformationOfTheGeo-fabric) to find your global or regional fabric URLs (endpoints).
