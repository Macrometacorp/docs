...
- You can now invoke EdgeWorkers with stream workers. [Edge Functions](../cep/query-guide/functions/edge-functions/edge-functions.md) was added as a result of this change.
