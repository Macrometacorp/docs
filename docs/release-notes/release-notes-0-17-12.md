...
- You can now invoke EdgeWorkers with stream workers. [Edge Functions](../cep/query-guide/functions/edge-functions/edge-functions) was added as a result of this change.
