...
To see if Dynamic Prerendering is currently running, you can use the [Gets service health status](/docs/apiPrerendering#/paths/api-prerender-v1-health/get) API endpoint.
...
2. **API Endpoints**: Use the [Fetches the prerendered page content](/docs/apiPrerendering#/paths/api-prerender-v1-render-mobile---url/get) endpoint to view the prerendered page.
