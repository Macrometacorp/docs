...
You have several options for viewing Prerender prefetching in progress or already completed.
...
Prerender provides the following prefetching fields. Field names in the web console are different than those in the API responses. Refer to the API endpoint documentation for a full explanation of the API response.
...
Prerender provides the following prefetching history fields.
