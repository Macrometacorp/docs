...
export default function APIVwrsServicePage() {
  ...
  return (
    <Layout>
      <Head>
        <title>PhotonIQ ObjectStore API Reference | Macrometa Docs</title>
        <meta name="description" content="PhotonIQ ObjectStore API" />
        <meta name="og:description" content="PhotonIQ ObjectStore API" />
        ...
        {() => {
          ...
          return (
            <>
              ...
              <API
                apiDescriptionUrl={`${siteConfig.baseUrl}openapi/objectstore-spec.json`}
                router="hash"
                basePath="/"
                layout="sidebar"
                hideSchemas={true}
